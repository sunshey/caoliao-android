...
import com.yc.liaolive.msg.iView.GroupInfoView;
import com.yc.liaolive.msg.manager.GroupInfoPresenter;
...
public class GroupProfileActivity extends FragmentActivity implements GroupInfoView, View.OnClickListener {
    ...
    public void showGroupInfo(List<TIMGroupDetailInfo> groupInfos) {
        ...
        isGroupOwner = info.getGroupOwner().equals(UserManager.getInstance().getUserId());
