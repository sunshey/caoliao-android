...
import com.yc.liaolive.msg.model.ProfileSummary;
import com.yc.liaolive.msg.adapter.ProfileSummaryAdapter;
...
public class GroupMemberActivity extends Activity implements TIMValueCallBack<List<TIMGroupMemberInfo>> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (type.equals(GroupInfo.privateGroup)){
            title.setMoreImg(R.drawable.iv_add_video_details_gray);
