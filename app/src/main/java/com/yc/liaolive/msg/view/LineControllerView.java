...
public class LineControllerView extends LinearLayout {
    ...
    public LineControllerView(Context context, AttributeSet attrs) {
        ...
        try {
            name = ta.getString(R.styleable.LineControllerView_linName);
            content = ta.getString(R.styleable.LineControllerView_linContent);
            isBottom = ta.getBoolean(R.styleable.LineControllerView_linIsBottom, false);
            canNav = ta.getBoolean(R.styleable.LineControllerView_linCanNav,false);
            isSwitch = ta.getBoolean(R.styleable.LineControllerView_linIsSwitch,false);
            setUpView();
        } finally {
            ta.recycle();
        }
