package com.yc.liaolive.msg.dao;

import android.content.Context;
import com.yc.liaolive.manager.DBDaoManager;
...
public class DBBaseDao<T> {
    public static final String TAG = DBBaseDao.class.getSimpleName();
    public static final boolean DUBUG = true;
    public DBDaoManager manager;
    public DaoSession daoSession;

    public DBBaseDao(Context context) {
        manager = DBDaoManager.getInstance();
