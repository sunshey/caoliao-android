...
import com.yc.liaolive.msg.iView.FriendshipManageView;
...
public class FriendshipManagerPresenter {
     ...
     * @param users
     */
    public void getUserInfo(List<String> users) {
        ...
        TIMFriendshipManager.getInstance().getUsersProfile(users, new TIMValueCallBack<List<TIMUserProfile>>() {
            ...
            public void onSuccess(List<TIMUserProfile> result) {
                ...
                FriendshipInfo.getInstance().updateFriendShips(result);
                if (friendInfoView != null) {
                    friendInfoView.showUserInfo(result);
                }
            }
        });
    }
