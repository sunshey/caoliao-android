...
public class ScreenUtils {
    ...
    public static float dpToPx(float dp) {
        return dp * VideoApplication.getInstance().getApplicationContext().getResources().getDisplayMetrics().density;
    }
    ...
    public static float pxToDp(float px) {
        return px / VideoApplication.getInstance().getApplicationContext().getResources().getDisplayMetrics().density;
    }
    ...
    public static float pxToSp(float pxValue) {
        return pxValue / VideoApplication.getInstance().getApplicationContext().getResources().getDisplayMetrics().scaledDensity;
    }
    ...
    public static float spToPx(float spValue) {
        return spValue * VideoApplication.getInstance().getApplicationContext().getResources().getDisplayMetrics().scaledDensity;
    }
    ...
    private int getStatusBarHeight() {
        ...
        try {
            ...
            sbar = VideoApplication.getInstance().getApplicationContext().getResources().getDimensionPixelSize(x);
        } catch (Exception e1) {
            e1.printStackTrace();
        }
        return sbar;
    ...
    public static void setActivityLight(Activity context, int brightness) {
