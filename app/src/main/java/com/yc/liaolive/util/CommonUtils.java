...
//	}
    ...
    public static Uri drawableResouceByString(int resourceID) {
        Resources  r =VideoApplication.getInstance().getResources();

        return Uri.parse(ContentResolver.SCHEME_ANDROID_RESOURCE + "://" + r.getResourcePackageName(resourceID));
    }
}
