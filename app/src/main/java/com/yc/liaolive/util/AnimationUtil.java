...
//        PathInterpolator========================新增的，就是可以定义路径坐标，然后可以按照路径坐标来跑动；注意其坐标并不
    ...
    public static void playTextCountAnimation(View view){
        ...
        view.clearAnimation();
        AnimatorSet animatorSet1=new AnimatorSet();
        ObjectAnimator animator1 = ObjectAnimator.ofFloat(view, "scaleX", 0.9f, 1.1f).setDuration(150);
        ObjectAnimator animator2 = ObjectAnimator.ofFloat(view, "scaleY", 0.9f, 1.1f).setDuration(150);
        animatorSet1.playTogether(animator1,animator2);//一起执行
        final AnimatorSet animatorSet2=new AnimatorSet();
        ObjectAnimator animator3 = ObjectAnimator.ofFloat(view, "scaleX", 1.1f, 1.0f).setDuration(100);
        ObjectAnimator animator4 = ObjectAnimator.ofFloat(view, "scaleY", 1.1f, 1.0f).setDuration(100);
        animatorSet2.setInterpolator(new OvershootInterpolator());
        animatorSet2.playTogether(animator3,animator4);
        animatorSet1.addListener(new AnimatorListenerAdapter() {
            @Override
     ...
     * @param duration
     */
    public static void startSuperAwardAnimOut(View view, long duration, final AnimatorPlayListener listener) {
        if (view == null) {
            return;
        }
        view.clearAnimation();
        PropertyValuesHolder pvhX = PropertyValuesHolder.ofFloat("scaleX", 1.0f, 0.5f);
        PropertyValuesHolder pvhY = PropertyValuesHolder.ofFloat("scaleY", 1.0f, 0.5f);
        PropertyValuesHolder alpha = PropertyValuesHolder.ofFloat("alpha", 1.0f, 0.0f);
        ObjectAnimator objectAnimator = ObjectAnimator.ofPropertyValuesHolder(view, pvhX, pvhY,alpha);
        objectAnimator.setDuration(duration);
        objectAnimator.setInterpolator(new LinearInterpolator());//一开始速度很快，后来越来越慢
     ...
     * @param duration
     */
    public static void startSuperAwardAnimIn(View view, long duration, final AnimatorPlayListener listener) {
        if (view == null) {
            return;
        }
        view.clearAnimation();
        PropertyValuesHolder pvhX = PropertyValuesHolder.ofFloat("scaleX", 0.5f, 1.0f);
        PropertyValuesHolder pvhY = PropertyValuesHolder.ofFloat("scaleY", 0.5f, 1.0f);
     ...
     * @param duration
     */
    public static void startSmallAwardAnimOut(View view, long duration, final AnimatorPlayListener listener) {
        if (view == null) {
            return;
        }
        view.clearAnimation();
     ...
     * @param duration
     */
    public static void startSmallAwardAnim(View view, long duration, final AnimatorPlayListener listener) {
        if (view == null) {
            return;
        }
        view.clearAnimation();
     ...
     * @param duration
     */
    public static void startSuperAwardUserAnim(View view, long duration, final AnimatorPlayListener listener) {
        if (view == null) {
            return;
        }
        view.clearAnimation();
