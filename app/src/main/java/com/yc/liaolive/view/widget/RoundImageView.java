...
public class RoundImageView extends AppCompatImageView {
    ...
    public void setImageResource(int resId) {
        ...
        mBitmap = Utils.getBitmapForDeawable(getDrawable());
        setupBitmapShader();
    }
    ...
    public void setImageDrawable(Drawable drawable) {
        ...
        mBitmap = Utils.getBitmapForDeawable(drawable);
        setupBitmapShader();
    }
    ...
    private void init(AttributeSet attrs) {
        if(null!=attrs){
            ...
            mShape = a.getInt(R.styleable.RoundImageView_roundShape, mShape);
            mRoundRadius = a.getDimension(R.styleable.RoundImageView_roundRadius, mRoundRadius);
            mBorderSize = a.getDimension(R.styleable.RoundImageView_roundBorderSize, mBorderSize);
            mBorderColor = a.getColor(R.styleable.RoundImageView_roundBorderColor, mBorderColor);
            a.recycle();
        }
    }
