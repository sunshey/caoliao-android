...
/**
 * Created by wanglin  on 2018/7/4 17:18.
 */
public class BaseItemDecoration extends RecyclerView.ItemDecoration {
    private static final int[] ATTRS = new int[]{listDivider};
    ...
    public void onDraw(Canvas c, RecyclerView parent, RecyclerView.State state) {
        ...
        if (parent.getLayoutManager().getClass() == LinearLayoutManager.class) {
            ...
            if (mOrientation == VERTICAL) {
                drawLinHorizontal(c, parent);
            } else {
                drawLinVertical(c, parent);
            }
     ...
     * @param parent
     */
    private void drawLinHorizontal(Canvas c, RecyclerView parent) {
     ...
     * @param parent
     */
    private void drawLinVertical(Canvas c, RecyclerView parent) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            mDivider.setBounds(left, top, right, bottom);
//            mDivider.setColorFilter(mColor, PorterDuff.Mode.SRC_IN);
            mDivider.draw(c);
