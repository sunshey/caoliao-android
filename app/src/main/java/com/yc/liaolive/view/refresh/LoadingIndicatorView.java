package com.yc.liaolive.view.refresh;
...
import com.yc.liaolive.view.refresh.indicators.LineScalePulseOutIndicator;
...
public class LoadingIndicatorView extends View {
    ...
    private void init(Context context,AttributeSet attrs,int defStyleAttr, int defStyleRes) {
        ...
        mMinWidth = a.getDimensionPixelSize(R.styleable.LoadingIndicatorView_loadingMinWidth, mMinWidth);
        mMaxWidth = a.getDimensionPixelSize(R.styleable.LoadingIndicatorView_loadingMaxWidth, mMaxWidth);
        mMinHeight = a.getDimensionPixelSize(R.styleable.LoadingIndicatorView_loadingMinHeight, mMinHeight);
        mMaxHeight = a.getDimensionPixelSize(R.styleable.LoadingIndicatorView_loadingMaxHeight, mMaxHeight);
        mIndicatorColor=a.getColor(R.styleable.LoadingIndicatorView_loadingIndicatorLoadColor, Color.WHITE);
        if (mIndicator==null){
            setIndicator(DEFAULT_INDICATOR);
        }
        a.recycle();
        setIndicator(LineScalePulseOutIndicator.class.getCanonicalName());//默认的动画样式
    }
