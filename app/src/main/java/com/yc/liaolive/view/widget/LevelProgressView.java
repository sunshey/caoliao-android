...
/**
 * Created by wanglin  on 2018/7/4 10:06.
 */
...
public class LevelProgressView extends View {
    private final String TAG = "LevelProgressView";
    //画笔
...
//    private int paddingStart = 10,paddingEnd = 0;
    ...
    public LevelProgressView(Context context, AttributeSet attrs) {
        super(context, attrs);
        //获取xml属性
        TypedArray typedArray = context.getTheme().obtainStyledAttributes(attrs, R.styleable.LevelProgressView, 0, 0);
        backGroundColor = typedArray.getColor(R.styleable.LevelProgressView_backGroundColor, Color.GRAY);
        barColor = typedArray.getColor(R.styleable.LevelProgressView_progressbarColor, Color.RED);
        drawable = typedArray.getDrawable(R.styleable.LevelProgressView_drawable);
        halfDrawableWidth = typedArray.getDimensionPixelSize(R.styleable.LevelProgressView_halfDrawableWidth, 35);
        halfDrawableHeight = typedArray.getDimensionPixelSize(R.styleable.LevelProgressView_halfDrawableHeight, 35);
        drawableHeightOffset = typedArray.getDimensionPixelSize(R.styleable.LevelProgressView_drawableHeightOffset, 0);
        isRound = typedArray.getBoolean(R.styleable.LevelProgressView_isRound, true);
        roundX = typedArray.getDimensionPixelSize(R.styleable.LevelProgressView_roundX, 20);
        roundY = typedArray.getDimensionPixelSize(R.styleable.LevelProgressView_roundY, 20);
        progress = typedArray.getInt(R.styleable.LevelProgressView_progress, 0);
        max = typedArray.getInt(R.styleable.LevelProgressView_progressMax, 100);
        isSetBar = typedArray.getBoolean(R.styleable.LevelProgressView_isSetBar, false);
        progressHeight = typedArray.getDimensionPixelSize(R.styleable.LevelProgressView_progressHeight, 30);
        progressHeightOffset = typedArray.getDimensionPixelSize(R.styleable.LevelProgressView_progressHeightOffset, 0);
        refreshTime = typedArray.getInt(R.styleable.LevelProgressView_refreshTime, 100);
        animMode = typedArray.getInt(R.styleable.LevelProgressView_animMode, ANIM_NULL);
        rotateRate = typedArray.getInt(R.styleable.LevelProgressView_rotateRate, 10);
        rotateDegree = typedArray.getInt(R.styleable.LevelProgressView_rotateDegree, 0);
        scaleMax = typedArray.getFloat(R.styleable.LevelProgressView_scaleMax, 2);
        scaleMin = typedArray.getFloat(R.styleable.LevelProgressView_scaleMin, 1);
        scaleRate = typedArray.getFloat(R.styleable.LevelProgressView_scaleRate, 0.1f);
        gradientStartColor = typedArray.getColor(R.styleable.LevelProgressView_gradientStartColor, Color.RED);
        gradientEndColor = typedArray.getColor(R.styleable.LevelProgressView_gradientEndColor, Color.YELLOW);
        isGradient = typedArray.getBoolean(R.styleable.LevelProgressView_isGradient, false);
        backgroundDrawableId = typedArray.getResourceId(R.styleable.LevelProgressView_backgroundDrawable, 0);
        barDrawableId = typedArray.getResourceId(R.styleable.LevelProgressView_barDrawable, 0);
        outColor = typedArray.getColor(R.styleable.LevelProgressView_outer_color, Color.WHITE);
        typedArray.recycle();
        init();
    }
