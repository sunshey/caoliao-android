...
public class LikeView extends View {
     ...
     * 心形默认颜色,默认是透明颜色最合适
     */
    private static final int CLICKED_CLOLOR = 0xFFFF4E5C;
    /**
     * 环绕圆点的颜色
     */
     ...
     * 展现View点击后的变化效果
     */
    public void startViewMotion(final OnAnimationListener onAnimationListener) {

        if (animatorTime != null && animatorTime.isRunning()) return;
        resetState();
