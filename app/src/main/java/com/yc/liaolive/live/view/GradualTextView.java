        ...
        if (null != animator) {
            ...
            animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                ...
                public void onAnimationUpdate(ValueAnimator valueAnimator) {
                    SpannableStringBuilder stringBuilder = LiveChatUserGradleSpan.giftNumFromat(valueAnimator.getAnimatedValue().toString());
                ...
                public void onAnimationEnd(Animator animator) {
                    ...
                    if(!TextUtils.isEmpty(trim)){
                        try {
                            ...
                            if(integer!=olderNum){
                                SpannableStringBuilder stringBuilder = LiveChatUserGradleSpan.giftNumFromat(String.valueOf(olderNum));
                                setText(stringBuilder);
                            }
                        }catch (Exception e){
