...
public class GradualWhiteTextView extends android.support.v7.widget.AppCompatTextView {
    ...
    public GradualWhiteTextView(Context context) {
        super(context);
    }

    public GradualWhiteTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
