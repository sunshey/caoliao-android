...
import com.yc.liaolive.live.view.beautysetting.RoundProgressBar;
import com.yc.liaolive.live.view.beautysetting.VideoMaterialMetaData;
import com.yc.liaolive.live.view.beautysetting.utils.FrescoUtils;
import com.yc.liaolive.live.view.beautysetting.utils.VideoMaterialDownloadManager;
import com.yc.liaolive.live.view.beautysetting.utils.VideoMaterialDownloadProgress;
...
public class LiveMaterialAdapter extends RecyclerView.Adapter<LiveMaterialAdapter.VideoViewHolder>{
    ...
    public LiveMaterialAdapter(Activity context, List<VideoMaterialMetaData> materials) {
            ...
            public void onClick(View v) {
                if(TextUtils.isEmpty(material.path)){
                    if (!isNetworkAvailable(mContext)) {
                        ToastUtils.showToast("网络不通，请检查网络设置");
                        return;
                    }
