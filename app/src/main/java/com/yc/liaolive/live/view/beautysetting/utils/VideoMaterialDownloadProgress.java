    ...
    public void start(Downloadlistener listener) {
        ...
        HttpFileListener fileListener = new HttpFileListener() {
            ...
            public void onSaveSuccess(File file) {
                ...
                String dataDir = VideoUtil1.unZip(file.getPath(), file.getParentFile().getPath());
        ...
        File onlineMaterialDir = VideoDeviceUtil1.getExternalFilesDir(VideoUtil1.getContext(), ONLINE_MATERIAL_FOLDER);
