...
//          paint.setTextAlign(Paint.Align.CENTER);
             ...
             */
            Shader shader_vertical=new LinearGradient(0, getHeight()/4, 0, getHeight(), Color.parseColor("#FFFF6D05"),  Color.parseColor("#FFC5322C"), Shader.TileMode.CLAMP);
            this.getPaint().setShader(shader_vertical);
        }
