...
public class ScreenLayoutChangedHelp {
    ...
    public ScreenLayoutChangedHelp(final Activity activity) {
        try {
            //获取activity的根视图
    ...
    public void onDestroy(){
        if(null!=rootView&&null!=onGlobalLayoutListener) rootView.getViewTreeObserver().removeOnGlobalLayoutListener(onGlobalLayoutListener);
        onSoftKeyBoardChangeListener=null; rootView=null;onGlobalLayoutListener=null;
    }
}
