 ...
 */
package com.yc.liaolive.base.adapter;
...
import com.yc.liaolive.base.adapter.animation.AlphaInAnimation;
import com.yc.liaolive.base.adapter.animation.BaseAnimation;
import com.yc.liaolive.base.adapter.animation.ScaleInAnimation;
import com.yc.liaolive.base.adapter.animation.SlideInBottomAnimation;
import com.yc.liaolive.base.adapter.animation.SlideInLeftAnimation;
import com.yc.liaolive.base.adapter.animation.SlideInRightAnimation;
import com.yc.liaolive.base.adapter.entity.IExpandable;
import com.yc.liaolive.base.adapter.loadmore.LoadMoreView;
import com.yc.liaolive.base.adapter.loadmore.SimpleLoadMoreView;
import com.yc.liaolive.base.adapter.util.MultiTypeDelegate;
    ...
    public int addHeaderView(View header, int index, int orientation) {
        if (mHeaderLayout == null) {
            ...
            if (orientation == LinearLayout.VERTICAL) {
                ...
                mHeaderLayout.setLayoutParams(new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT));
            } else {
                mHeaderLayout.setOrientation(LinearLayout.HORIZONTAL);
                mHeaderLayout.setLayoutParams(new LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.MATCH_PARENT));
            }
        }
