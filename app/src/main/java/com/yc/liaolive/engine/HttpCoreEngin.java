...
public class HttpCoreEngin<T> extends BaseEngin<T> {
    ...
    public Observable<ResultInfo<T>> rxget(String url, Type type, boolean isEncryptResponse) {
        return rxget(url, type, null, null, isEncryptResponse);
    }


    public Observable<ResultInfo<T>> rxget(String url, Type type, Map<String, String> params, boolean isEncryptResponse) {
        return rxget(url, type, params, null, isEncryptResponse);
    }

    public Observable<ResultInfo<T>> rxget(String url, Type type, Map<String, String> params, Map<String, String> headers,
    ...
    public Observable<ResultInfo<T>> rxpost(String url, Type type, Map<String, String> params, Map<String, String> headers,
