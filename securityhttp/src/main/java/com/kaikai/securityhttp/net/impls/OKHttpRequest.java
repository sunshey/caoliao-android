package com.kaikai.securityhttp.net.impls;


import com.kaikai.securityhttp.net.entry.UpFileInfo;
import com.kaikai.securityhttp.net.exception.NullResonseListenerException;
import com.kaikai.securityhttp.net.interfaces.IHttpRequest;
import com.kaikai.securityhttp.utils.LogUtil;
import com.kaikai.securityhttp.net.contains.HttpConfig;
import com.kaikai.securityhttp.net.listeners.OnHttpResonseListener;
...
public class OKHttpRequest implements IHttpRequest {
    ...
    @Override
    public com.kaikai.securityhttp.net.entry.Response get(String url, Map<String, String> params, Map<String, String> headers, boolean isEncryptResponse) throws IOException {
    ...
    @Override
    public com.kaikai.securityhttp.net.entry.Response post(String url, Map<String, String> header, MediaType type, String
    ...
    @Override
    public com.kaikai.securityhttp.net.entry.Response post(String url, Map<String, String> params, Map<String, String> headers, boolean isrsa, boolean iszip, boolean isEncryptResponse) throws IOException, NullResonseListenerException {
    ...
    @Override
    public com.kaikai.securityhttp.net.entry.Response uploadFile(String url, UpFileInfo upFileInfo, Map<String, String> params, Map<String, String> headers, boolean isEncryptResponse) throws IOException {
    ...
    private com.kaikai.securityhttp.net.entry.Response sendRequest(Request request, boolean isEncryptResponse) throws IOException {
        com.kaikai.securityhttp.net.entry.Response nresponse = null;
        if (request == null) {
        ...
        if (nresponse == null) {
            nresponse = new com.kaikai.securityhttp.net.entry.Response();
            nresponse.body = response.body().string();
    ...
    private void sendRequest(Request request, final boolean
        ...
        call.enqueue(new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                com.kaikai.securityhttp.net.entry.Response response = OKHttpUtil.setResponse(-1, HttpConfig.NET_ERROR);
