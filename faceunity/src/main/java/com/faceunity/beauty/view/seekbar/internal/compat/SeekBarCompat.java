package com.faceunity.beauty.view.seekbar.internal.compat;
...
import com.faceunity.beauty.view.seekbar.internal.drawable.AlmostRippleDrawable;
...
public class SeekBarCompat {
     ...
     */
    @TargetApi(21)
    static class SeekBarCompatDontCrash {
