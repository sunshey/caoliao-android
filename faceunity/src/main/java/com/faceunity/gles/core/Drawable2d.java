    ...
    public Drawable2d(Prefab shape) {
        switch (shape) {
            case TRIANGLE:
                ...
                mVertexCount = TRIANGLE_COORDS.length / COORDS_PER_VERTEX;
                break;
            case RECTANGLE:
                mVertexArray = RECTANGLE_BUF;
                mTexCoordArray = RECTANGLE_TEX_BUF;
                mVertexCount = RECTANGLE_COORDS.length / COORDS_PER_VERTEX;
                break;
            case FULL_RECTANGLE:
