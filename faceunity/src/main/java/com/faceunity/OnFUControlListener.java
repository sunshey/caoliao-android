...
public interface OnFUControlListener {
     ...
     * @param progress 脸型程度
     */
    void onFaceStylelSelected(float progress);
     ...
     * @param timestampNs
     */
    int onRenderingFrame(int textureId, int width, int height, long timestampNs);
     ...
     * @param timestampNs
     */
    void onPreviewFrame(byte[] bytes, int width, int height, int rotation, int fmt, long timestampNs);
     ...
     * @param orientation
     */
    void onCameraChange(int cameraId,int orientation);
